...
figlet ENCRYPTION DECRYPTION AUTOMATION TOOLS
tool(){
...
if [[ $first_input == "q" ]]; then 
		...
		file_check
                ...
                echo "Enter something in the file."
...
name_enc
        ...
        encryption_process(){
                ...
                if [[ $enc_type == 'a' ]]; then
                        ...
                        echo -n "Enter a password for the encryption: "
                        stty -echo
                        read password
                        stty echo
                        echo ""
                        echo  "Which style format do you want to use?"
                        ...
                        echo -n "."
                        sleep 1
                        echo "Encryption completed and worked successfully."
                        sleep 1
                        echo "Redirecting..."
                        sleep 1
                        tool
	...
	dec_name
                ...
                if [[ $encr_key == 'a' ]]; then
                        ...
                        sleep 1
			echo "Decryption process completed and run succesfully."
			sleep 1
	...
	to_rerun
			...
			stty echo
                        echo "" 
                        echo "Which style was used during encryption? "
                        cat -n enc_algrthm.txt
                        read in_algrthm
                        nu=$(sed -n $in_algrthm"p" enc_algrthm.txt)
